...
class Animation {
    ...
    public Animation(String spriteName, String animationName) {
        ...
        for (int i = 0; i < info.size(); i++) {
            ...
            // Generate ArrayList of Images and their repsective delays
    ...
    public PImage nextFrame(float speed) {
      ...
      // Return image depending on character speed, image delay and time since image was last changed
